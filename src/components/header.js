           ...
           <div className="collapse navbar-collapse" id="navbarSupportedContent">
             <ul className="navbar-nav me-auto mb-2 mb-lg-0">
               <li className="nav-item  ms-lg-5">
                 <a className={`nav-link ${pageDisplayed === 'Home' ? 'active' : ''}    fs-6`} aria-current="page" href="#" onClick={() => {changeTab('Home')}}>{t('home')}</a>
               </li>
               ...
               <li className="nav-item ms-lg-4">
                 <a className={`nav-link ${pageDisplayed === 'Formulations' ? 'active' : ''}    fs-6`} href="#" onClick={() => {changeTab('Formulations')}}>{t('formulations-title')}</a>
               </li>
               <li className="nav-item ms-lg-4">
                 <a className={`nav-link ${pageDisplayed === 'Bottling' ? 'active' : ''}    fs-6`} href="#" onClick={() => {changeTab('Bottling')}}>{t('bottling-tittle')}</a>
               </li>
             </ul>
